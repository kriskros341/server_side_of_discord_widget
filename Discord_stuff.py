...
class DiscordWsHandler:
    ...
    def set_functional_interface(self, functional_interface, db):
        assert functional_interface is not None, \
            print(f"{functional_interface} is not valid a valid functional interface")
    ...
    async def send_handshake_and_start_pinging(self, ws):
